...
/*
  MATRIX TOP-3 · HORIZONTAL v1.4.3
...
(() => {
  ...
  function eraHtml(era){
    ...
    h+=`<div class="hm-table-wrap" data-schedule-era="${era}"><table class="hm-table ${era==='old'?'old-grid':''}"><thead><tr><th class="hm-date-head">Дата / день</th>${times.map(t=>`<th class="hm-time">${t}</th>`).join('')}</tr></thead><tbody>`;
